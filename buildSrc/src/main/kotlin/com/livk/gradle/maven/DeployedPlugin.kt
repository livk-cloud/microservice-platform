...
abstract class DeployedPlugin : Plugin<Project> {
    ...
    private fun mavenInfo(publication: MavenPublication, project: Project) {
        ...
        publication.pom {
            ...
            it.url.set("https://github.com/livk-cloud/livk-microservice/" + project.name)
            it.licenses {
                it.license {
            ...
            it.scm {
                it.connection.set("git@github.com:livk-cloud/livk-microservice.git")
                it.url.set("https://github.com/livk-cloud/livk-microservice")
            }
        }
    }
}
